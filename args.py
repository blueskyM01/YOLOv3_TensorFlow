...
### Some paths
train_file = './data/my_data/train_voc.txt'  # The path of the training txt file.
val_file = './data/my_data/val_voc.txt'  # The path of the validation txt file.
restore_path = './data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = '/media/yang/F/ubuntu/YOLO3/VOC_my_dataset/checkpoint/'  # The directory of the weights to save.
log_dir = '/media/yang/F/ubuntu/YOLO3/VOC_my_dataset/data/logs/'  # The directory to store the tensorboard log files.
progress_log_path = '/media/yang/F/ubuntu/YOLO3/VOC_my_dataset/data/progress.log'  # The path to record the training progress.
